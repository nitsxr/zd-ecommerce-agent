...
●
Turn 1: A user asks a question about a product (e.g.,
"Can I return my Bluetooth
headphones?").
●
Turn 2: The user follows up with,
"Alright, cancel the order for that then.
"
...
○
Share your submission with: zendesk-chak, tuncgultekin, jordizendesk,
miguel-zendesk, yonatanwilkofzendesk, shub-kris, evan-strom, martinstiago
○
Please also send an email with the link to the repository to
magdalena.korzecmaro@zendesk.com